...
is the auto-formatter Black [8]_. A particular requirement with these kinds of
...
to identify widely-used parsing libraries (such as libCST) and upgrade them to be
PEG compatible. (Bonus points for removing the need to fork them.)
